...
var e = JSON.parse(t);
o.url = e.url;
o.privacyUrl = e.privacyUrl;
cc.log(t);
cc.log("当前appType为" + e.appType);
switch (e.appType) {
case 1:
...
var o;
r([ a(cc.Node) ], e.prototype, "changelogView", void 0);
r([ a(cc.Label) ], e.prototype, "changelogTitleLabel", void 0);
r([ a(cc.Label) ], e.prototype, "changelogContentLabel", void 0);
r([ a(cc.Button) ], e.prototype, "privacyButton", void 0);
r([ a(cc.Button) ], e.prototype, "startButton", void 0);
r([ a(cc.Button) ], e.prototype, "retryButton", void 0);
r([ a(cc.Node) ], e.prototype, "errorView", void 0);
r([ a(cc.Node) ], e.prototype, "webView", void 0);
return e = o = r([ i ], e);
}(cc.Component);
o.default = p;
cc._RF.pop();
...
r([ p(cc.Sprite) ], e.prototype, "race", void 0);
r([ p(cc.Sprite) ], e.prototype, "job", void 0);
r([ p(cc.Label) ], e.prototype, "raceLabel", void 0);
r([ p(cc.Label) ], e.prototype, "jobLabel", void 0);
return e = r([ a ], e);
}(cc.Component);
o.default = s;
cc._RF.pop();
...
var c = t("./Appegg"), i = cc._decorator, a = i.ccclass, p = i.property, s = function(t) {
n(e, t);
function e() {
return null !== t && t.apply(this, arguments) || this;
}
e.prototype.onLoad = function() {
cc.log("privacyUrl" + c.default.privacyUrl);
this.webView.url = c.default.privacyUrl;
};
...
r([ p(cc.Node) ], e.prototype, "hideScene", void 0);
r([ p(cc.Node) ], e.prototype, "showScene", void 0);
r([ p(c.default) ], e.prototype, "GameManager", void 0);
r([ p ], e.prototype, "id", void 0);
return e = r([ a ], e);
}(cc.Component);
o.default = s;
cc._RF.pop();
...
if (r < o) {
c.active = !0;
var i = n + r, a = Math.floor(i / 7), p = i % 7, s = .5 * -(this.ndDays.width - c.width) + p * c.width, u = .5 * (this.ndDays.height - c.height) - a * c.height;
c.setPosition(s, u);
...
r([ p(cc.EditBox) ], e.prototype, "nameBox", void 0);
r([ p(cc.EditBox) ], e.prototype, "yearBox", void 0);
r([ p(cc.EditBox) ], e.prototype, "monthBox", void 0);
r([ p(cc.EditBox) ], e.prototype, "dateBox", void 0);
r([ p(cc.Label) ], e.prototype, "yearLabel", void 0);
r([ p(cc.Label) ], e.prototype, "monthLabel", void 0);
r([ p(cc.Label) ], e.prototype, "dayLabel", void 0);
r([ p(cc.Label) ], e.prototype, "errorLabel", void 0);
return e = r([ a ], e);
}(cc.Component);
o.default = s;
cc._RF.pop();
...
r([ p ], e.prototype, "gender", void 0);
r([ p(cc.Node) ], e.prototype, "hideView", void 0);
...
var c = t("./Appegg"), i = cc._decorator, a = i.ccclass, p = (i.property, function(t) {
n(e, t);
function e() {
return null !== t && t.apply(this, arguments) || this;
}
...
this.getComponent(cc.WebView).url = c.default.url;
};
return e = r([ a ], e);
}(cc.Component));
o.default = p;
